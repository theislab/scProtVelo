...
from scvelo.tools.utils import get_indices, get_iterative_indices
...
class VelocityGraph:
    ...
    def __init__(
        ...
        # normalizes velocities in a way that cells change in a way that preserves their cell size
